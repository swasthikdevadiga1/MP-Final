...
export default function AdminPage() {
  ...
  const handleUpload = async (file) => {
    ...
    const ok   = ["pdf","png","jpg","jpeg","webp","bmp"].includes(ext);
    if (!ok) { toast.error("Only PDF and image files are allowed."); return; }
  ...
  const handleReprocess = async (id, name) => {
    try {
      await reprocessDocAPI(id);
      toast.success(`Reprocessing "${name}"…`);
      fetchDocs();
        ...
        <div className="max-w-4xl mx-auto px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-sm mt-1">
              Upload PDFs or images — EduBot will extract text and index them automatically
            </p>
          </div>
                ...
                <>
                  <div>
                    ...
                    <p className="text-gray-600 text-xs mt-1">
                      PDF, PNG, JPG, WEBP, BMP · Max 50 MB
                    </p>
                  </div>
